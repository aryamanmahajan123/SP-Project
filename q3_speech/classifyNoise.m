...
[fan,fs1] = audioread("speech_ceiling-fan.wav");

[traffic,fs2] = audioread("speech_city-traffic.wav");

[cooker,fs3] = audioread("speech_pressure-cooker.wav");

[pump,fs4] = audioread("speech_water-pump.wav");
